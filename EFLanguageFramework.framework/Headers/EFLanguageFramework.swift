...
public class EFLanguageFramework: NSObject {
    private static var __once: () = {
            Static.staticInstance = EFLanguageFramework()
        }()
    fileprivate struct Static {
        static var onceToken : Int = 0
        static var staticInstance : EFLanguageFramework? = nil
    }
    ...
    // 单列
    public class func standardLanguage()->EFLanguageFramework{
        _ = EFLanguageFramework.__once
...
public func localized(_ key:String) -> String {
    return EFLanguageFramework.standardLanguage().string(key)
}

public func localizedImage(_ key:String)->UIImage? {
    return EFLanguageFramework.standardLanguage().image(key)
}
